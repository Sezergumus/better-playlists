...
export default function Loading() {
  return (
    <div className="loading-container flex flex-col items-center justify-center w-screen h-screen gap-8 bg-bgPrimary">
      {/* <Image src={loadingGIF} alt="Loading" width={320} height={320} /> */}
      <svg
